...
CREATE TABLE `calculate_item` (
  ...
  `employee_id` int(11) NOT NULL COMMENT '所属员工id',
  `item_id` int(11) NOT NULL COMMENT '所属项目id',
  `expression` varchar(45) DEFAULT NULL COMMENT '计算表达式，如：加班次数*单次补贴值',
  `value` double NOT NULL DEFAULT '0' COMMENT '计算结果具体值',
  `date` date NOT NULL DEFAULT '2020-01-01' COMMENT '工资所属日期(只取到月)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='计算项目:工资项目四个类型的一种，是需要使用表达式计算的项目，如：请假扣款要请假次数*单次扣款值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calculate_item` VALUES (1,43,7,'请假次数*10',50,'2020-01-01');
...
CREATE TABLE `fixed_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='固定项目:工资项目四个类型之一，表示具体值相对固定无需后续计算的项目，如基本工资，高温津贴等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `fixed_item` VALUES (1,45,1,3666,'2020-01-01'),(2,45,2,300,'2020-01-01'),(3,45,3,0,'2020-01-01'),(4,45,4,0,'2020-01-01'),(5,46,1,4777,'2020-01-01'),(6,46,2,300,'2020-01-01'),(7,46,3,0,'2020-01-01'),(8,46,4,0,'2020-01-01'),(9,48,1,5888,'2020-01-01'),(10,48,2,300,'2020-01-01'),(11,48,3,0,'2020-01-01'),(12,48,4,0,'2020-01-01'),(13,43,1,3000,'2020-01-01'),(14,43,2,300,'2020-01-01');
...
CREATE TABLE `import_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='导入项目:四个工资项目类型之一,是可能需要外部批量导入的如请假或迟到等考勤记录或加班记录等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `import_item` VALUES (2,43,5,5,'2020-01-01');
...
CREATE TABLE `item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工资项目，记录各种类型的工资项目';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `salary_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工资结果:工资条';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-09-16 11:44:50
