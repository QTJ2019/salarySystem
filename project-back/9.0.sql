...
CREATE TABLE `actual_salary_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='实发项目:工资项目四个类型之一，实发项目只有"工资发放"这一种';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `actual_salary_item` VALUES (1,43,13,3250,2,'2020-01-01'),(3,56,13,4659.75,2,'2020-03-01');
...
CREATE TABLE `calculate_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=105 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='计算项目:工资项目四个类型的一种，是需要使用表达式计算的项目，如：请假扣款要请假次数*单次扣款值';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `calculate_item` VALUES (2,43,7,10,'2020-01-01',0),(3,43,18,630,'2020-01-01',0),(4,43,23,240,'2020-01-01',0),(5,43,19,270,'2020-01-01',0),(6,43,24,60,'2020-01-01',0),(7,43,20,60,'2020-01-01',0),(8,43,25,30,'2020-01-01',0),(9,43,21,15,'2020-01-01',0),(10,43,22,24,'2020-01-01',0),(11,43,26,240,'2020-01-01',0),(12,43,27,240,'2020-01-01',0),(89,56,7,20,'2020-03-01',1),(90,56,9,5,'2020-03-01',1),(91,56,12,10,'2020-03-01',1),(92,56,17,500,'2020-03-01',1),(93,56,7,10,'2020-03-01',1),(94,56,18,1050,'2020-03-01',1),(95,56,23,400,'2020-03-01',1),(96,56,19,450,'2020-03-01',1),(97,56,24,100,'2020-03-01',1),(98,56,20,100,'2020-03-01',1),(99,56,25,50,'2020-03-01',1),(100,56,21,25,'2020-03-01',1),(101,56,22,40,'2020-03-01',1),(102,56,26,400,'2020-03-01',1),(103,56,27,400,'2020-03-01',1),(104,56,28,245.25,'2020-03-01',1);
...
CREATE TABLE `fixed_item` (
  ...
  `state` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='固定项目:工资项目四个类型之一，表示具体值相对固定无需后续计算的项目，如基本工资，高温津贴等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `import_item` (
  ...
  `state` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='导入项目:四个工资项目类型之一,是可能需要外部批量导入的如请假或迟到等考勤记录或加班记录等';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `import_item` VALUES (2,43,5,5,'2020-02-01',0),(3,43,5,1,'2020-01-01',1),(4,56,5,2,'2020-03-01',1),(5,56,6,1,'2020-03-01',1),(6,56,11,1,'2020-03-01',1),(7,56,16,5,'2020-03-01',1),(8,56,5,1,'2020-03-01',1);
...
CREATE TABLE `salary_result` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=338 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='工资结果:工资条';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salary_result` VALUES (337,56,4659.75,5000,3,1,30,1,5,5,10,500,200,100,50,50,1050,400,450,100,100,50,25,40,400,400,245.25,'2020-03-01');
...
-- Dump completed on 2020-09-22 21:08:05
